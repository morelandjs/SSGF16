...
\begin{frame}{Studying bulk properties of the QGP liquid}
    \begin{center}
        \begin{tikzpicture}
            \node[anchor=center, xshift=1cm, yshift=0.75cm] (qgp) at (current page.center) {\includegraphics[width=0.35\textwidth]{qgp}};
...
\begin{frame}{Studying the QGP equation of state}
    ...
    \begin{columns}[T]
        ...
        \end{column}
        \begin{column}{0.3\textwidth}
            \vspace{-.3cm} \includegraphics[width=.7\textwidth]{lattice}
        \end{column}
        \begin{column}{0.1\textwidth}
        \end{column}
    \end{columns}
...
\begin{frame}[t,plain]{Lattice QCD equation of state error analysis}
    ...
    \begin{columns}[t]
        ...
        \begin{column}{0.575\textwidth}
            ...
            \medskip
            \begin{tikzpicture}
                \node at (3.,-1.4) {\includegraphics[width=0.7\linewidth]{trace}};
        ...
        \begin{column}{0.4\textwidth}
            \bigskip
            \begin{tikzpicture}
                \node at (2.2,-3.2) {\includegraphics[height=0.8\textheight]{eos_compare}};
...
\begin{frame}[t]{Running the model with high probability parameters}
    ...
    \end{columns}
    \vspace{0.5 cm}
    \only<1>{\centering\includegraphics[width=0.85\textwidth]{mode_observables}}
    \only<2>{
        \bigskip
        \begin{columns}[T]
            \begin{column}{0.05\textwidth}
